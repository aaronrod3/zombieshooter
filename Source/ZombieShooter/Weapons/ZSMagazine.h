 ...
 *  AZSWeapon owns CurrentMagazineAmmo; reserve ammo is a real inventory item (B0-T2.11,
 *  UZSWeaponConfig::AmmoItemConfig), not tracked on this actor at all. This actor only represents
 *  the magazine visually. Never replicated - each machine spawns its own from
