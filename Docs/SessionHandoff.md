...
- New `UZSDragDropPayload::Make(FGuid, EZSDragSourceKind)` static factory — one node instead of Construct Object from Class + 2 Set nodes in `WBP_ZS_ItemSlot`'s On Drag Detected.
